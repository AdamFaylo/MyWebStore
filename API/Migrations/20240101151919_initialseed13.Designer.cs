...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20240101151919_initialseed13")]
    partial class initialseed13
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 31, 17, 19, 19, 692, DateTimeKind.Local).AddTicks(7001),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 30, 17, 19, 19, 692, DateTimeKind.Local).AddTicks(7048),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 31, 15, 19, 19, 692, DateTimeKind.Utc).AddTicks(6880)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 30, 15, 19, 19, 692, DateTimeKind.Utc).AddTicks(6899)
                        });
                });
