...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231228173304_initialseed6")]
    partial class initialseed6
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 27, 19, 33, 3, 762, DateTimeKind.Local).AddTicks(4669),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 26, 19, 33, 3, 762, DateTimeKind.Local).AddTicks(4734),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 27, 17, 33, 3, 762, DateTimeKind.Utc).AddTicks(4542)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 26, 17, 33, 3, 762, DateTimeKind.Utc).AddTicks(4550)
                        });
                });
