...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231228170033_initialseed4")]
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 27, 19, 0, 33, 197, DateTimeKind.Local).AddTicks(7492),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 26, 19, 0, 33, 197, DateTimeKind.Local).AddTicks(7538),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 27, 17, 0, 33, 197, DateTimeKind.Utc).AddTicks(7422)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 26, 17, 0, 33, 197, DateTimeKind.Utc).AddTicks(7430)
                        });
                });
