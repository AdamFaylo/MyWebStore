...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20240101055537_initialseed10")]
    partial class initialseed10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 31, 7, 55, 37, 341, DateTimeKind.Local).AddTicks(2581),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 30, 7, 55, 37, 341, DateTimeKind.Local).AddTicks(2618),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 31, 5, 55, 37, 341, DateTimeKind.Utc).AddTicks(2516)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 30, 5, 55, 37, 341, DateTimeKind.Utc).AddTicks(2524)
                        });
                });
