...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231228173128_initialseed5")]
            ...
            modelBuilder.Entity("MyProject.API.Models.LogoImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Alt = "Logo vanes site",
                            Logo = "https://logoipsum.com/artwork/323"
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 27, 19, 31, 28, 593, DateTimeKind.Local).AddTicks(3151),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 26, 19, 31, 28, 593, DateTimeKind.Local).AddTicks(3189),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 27, 17, 31, 28, 593, DateTimeKind.Utc).AddTicks(3020)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 26, 17, 31, 28, 593, DateTimeKind.Utc).AddTicks(3027)
                        });
                });
