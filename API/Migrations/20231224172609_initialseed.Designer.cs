...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231224172609_initialseed")]
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 23, 19, 26, 9, 409, DateTimeKind.Local).AddTicks(245),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 22, 19, 26, 9, 409, DateTimeKind.Local).AddTicks(288),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 23, 17, 26, 9, 409, DateTimeKind.Utc).AddTicks(159)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 22, 17, 26, 9, 409, DateTimeKind.Utc).AddTicks(167)
                        });
                });
