...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20240101151754_initialseed12")]
    partial class initialseed12
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 31, 17, 17, 53, 761, DateTimeKind.Local).AddTicks(1652),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 30, 17, 17, 53, 761, DateTimeKind.Local).AddTicks(1693),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 31, 15, 17, 53, 761, DateTimeKind.Utc).AddTicks(1545)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 30, 15, 17, 53, 761, DateTimeKind.Utc).AddTicks(1553)
                        });
                });
