...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231225213002_initialseed3")]
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 24, 23, 30, 2, 130, DateTimeKind.Local).AddTicks(2497),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 23, 23, 30, 2, 130, DateTimeKind.Local).AddTicks(2537),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 24, 21, 30, 2, 130, DateTimeKind.Utc).AddTicks(2431)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 23, 21, 30, 2, 130, DateTimeKind.Utc).AddTicks(2438)
                        });
                });
