...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231225053001_initialseed2")]
            ...
            modelBuilder.Entity("MyProject.API.Models.LogoImage", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            Alt = "Logo vanes site",
                            Logo = "https://i.imgur.com/VcU01l9.png"
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 24, 7, 30, 1, 248, DateTimeKind.Local).AddTicks(1359),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 23, 7, 30, 1, 248, DateTimeKind.Local).AddTicks(1396),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 24, 5, 30, 1, 248, DateTimeKind.Utc).AddTicks(1305)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 23, 5, 30, 1, 248, DateTimeKind.Utc).AddTicks(1312)
                        });
                });
