...
namespace MyProject.API.Migrations
{
    ...
    [Migration("20231231162921_initialseed8")]
    partial class initialseed8
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MyProject.API.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CustomerID = 1,
                            IsPaid = true,
                            OrderDate = new DateTime(2023, 12, 30, 18, 29, 20, 945, DateTimeKind.Local).AddTicks(6969),
                            ShippingAddressID = 1
                        },
                        new
                        {
                            ...
                            CustomerID = 2,
                            IsPaid = false,
                            OrderDate = new DateTime(2023, 12, 29, 18, 29, 20, 945, DateTimeKind.Local).AddTicks(7025),
                            ShippingAddressID = 2
                        });
                });
            ...
            modelBuilder.Entity("MyProject.API.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 29.90m,
                            OrderID = 1,
                            PaymentDate = new DateTime(2023, 12, 30, 16, 29, 20, 945, DateTimeKind.Utc).AddTicks(6850)
                        },
                        new
                        {
                            ID = 2,
                            Amount = 39.90m,
                            OrderID = 2,
                            PaymentDate = new DateTime(2023, 12, 29, 16, 29, 20, 945, DateTimeKind.Utc).AddTicks(6860)
                        });
                });
